...
let AppService = class AppService {
    ...
    findAll(user) {
        ...
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].github}/${user}/repos`, { headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(resp => resp.map(res => {
